...
background-image: url(https://sentiwiki.copernicus.eu/__attachments/1680406/Sentinel-1.jpg?inst-v=4173af95-a9c8-423a-ad60-8ad8fb81a94c)
---
...
- Ban et al. (2020) on using Sentinel SAR data to train a deep neural network classifier for near-real time fire detection 
  - Researchers from Sweden and British Columbia have used SAR images to create identify areas burned by fires from the Sentinel 1 SAR images.
  - [Add image here]
