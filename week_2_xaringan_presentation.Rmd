...
![](https://sentiwiki.copernicus.eu/__attachments/1680406/Sentinel-1.jpg?inst-v=4173af95-a9c8-423a-ad60-8ad8fb81a94c)
---
...
- Ollie Ballingers's PWTT research on building damage detection
  ...
  - ![](https://github.com/oballinger/PWTT/raw/main/figs/pwtt_pre_post.png)
...
![](https://media.springernature.com/lw685/springer-static/image/art%3A10.1038%2Fs41598-019-56967-x/MediaObjects/41598_2019_56967_Fig5_HTML.png?as=webp)
...
```{r}
library(knitr)
knitr::include_graphics('images/SNN similarity flow diagram.png')
```
